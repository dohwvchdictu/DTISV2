                        ...
                        <div class="sm:col-span-10">
                            <div class="max-w-sm space-y-3">
                                ...
                                <select wire:model='category_id' id="category_id" name="category_id" data-hs-select='{
                                    ...
                                    "optionClasses": "py-2 px-4 w-full text-sm text-slate-600 cursor-pointer hover:bg-gray-100 rounded-lg focus:outline-none focus:bg-gray-100 dark:bg-neutral-900 dark:hover:bg-neutral-800 dark:text-neutral-200 dark:focus:bg-neutral-800",
                        ...
                        <div class="sm:col-span-10">
                            <div class="max-w-sm space-y-3">
                                <input wire:model="user['id']" type="text"
                                    class="py-3 px-4 block w-full border-gray-200 bg-slate-100 text-slate-500 shadow rounded-lg text-sm disabled:opacity-50 disabled:pointer-events-none"
