            ...
            <div class="mb-4 flex justify-between items-center border-b border-gray-200 dark:border-neutral-700">
                <div>
                    <h3 class="py-2 text-xl font-semibold text-emerald-600 dark:text-neutral-200">Status
                        Disaggregation - External Requests</h3>
                </div>
                        ...
                        <div class="grow">
                            ...
                            <div class="mt-1 flex items-center gap-x-2">
                                <h3 class="text-xl sm:text-2xl font-medium text-gray-800 dark:text-neutral-200">
                                    {{ number_format(
                                        $incoming = \App\Models\Document::where('source', 'external')->whereIn('status', ['For Receiving', 'Returned'])->whereBetween('created_at', [
                        ...
                        <div class="grow">
                            ...
                            <div class="mt-1 flex items-center gap-x-2">
                                <h3 class="text-xl font-medium text-gray-800 dark:text-neutral-200">
                                    {{ number_format(
                                        $pending = \App\Models\Document::where('source', 'external')->whereBetween('created_at', [
                                                \Carbon\Carbon::parse($this->startDate)->addDay(1),
                                                \Carbon\Carbon::parse($this->endDate)->addDay(1),
                    ...
                    <div class="p-4 md:p-5 flex gap-x-4">
                        ...
                        <div class="grow">
                            ...
                            <div class="mt-1 flex items-center gap-x-2">
                                <h3 class="text-xl sm:text-2xl font-medium text-gray-800 dark:text-neutral-200">
                                    {{ number_format(
                                        $processed = \App\Models\Document::where('source', 'external')->whereNull('bundle_id')->whereBetween('created_at', [
                                                \Carbon\Carbon::parse($this->startDate)->addDay(1),
                                                \Carbon\Carbon::parse($this->endDate)->addDay(1),
                                            ])->count(),
                                    ) }}
                            ...
                            <div
                                ...
                                <div>
                                    <h2 class="text-xl font-bold text-emerald-700 dark:text-neutral-200">
                                        External Requests by Office
                                    </h2>
                                    <p class="text-sm text-gray-600 dark:text-neutral-400 mb-2">
                                        Monthly summary of the external requests per office.
                                    </p>
                                </div>
                                <div>
                                            ...
                                            <td class="size-px whitespace-nowrap">
                                                <span class="block relative z-10">
                                                    <div class="px-6 text-amber-600 flex gap-x-1">
                                                        {{ number_format(
                                                            $incoming = \App\Models\Document::where('source', 'external')->where('assigned_to', $office['id'])->whereIn('status', ['For Receiving', 'Returned'])->whereBetween('created_at', [
                                                                    \Carbon\Carbon::parse($this->startDate)->addDay(1),
                                                                    \Carbon\Carbon::parse($this->endDate)->addDay(1),
                                                                ])->count(),
                                                        ) }}
                                            ...
                                            <td class="size-px whitespace-nowrap">
                                                <span class="block relative z-10">
                                                    <div class="px-6 flex text-red-600 gap-x-1">
                                                        {{ number_format(
                                                            $pending = \App\Models\Document::where('source', 'external')->where('assigned_to', $office['id'])->whereBetween('created_at', [
                                                                    \Carbon\Carbon::parse($this->startDate)->addDay(1),
                                                                    \Carbon\Carbon::parse($this->endDate)->addDay(1),
                                                                ])->whereIn('status', ['On Process'])->count(),
                                                        ) }}
                                            ...
                                            <td class="size-px whitespace-nowrap">
                                                <span class="block relative z-10">
                                                    <div class="px-6 flex text-emerald-600 gap-x-1">
                                                        {{ number_format(
                                                            $processed = \App\Models\Document::where('source', 'external')->whereNull('bundle_id')->whereRelation('logs', 'assigned_to', $office)->whereHas('logs', function ($query) {
